...
const IndexPage = () => {
	...
	return (<div style={{position:"relative", height:"100vh"}}>
				...
				<p style={{ position: "absolute", right: "10px", bottom: "3px", color: "#323865", fontSize: "calc(8px + 0.4vw)" }}>Have a question? Experiencing troubles with completeing your application? Email us at <a href="mailto: novaxnetwork@gmail.com">novaxnetwork@gmail.com</a>.</p>
			</div>
  )
}
